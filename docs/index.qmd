...
updated_defense <- top10_2020 %>%
  left_join(top10_2024, by="uei")
```

**Let's fix these tables. Get one table, and have the years side by side and the difference in spending as the fourth column. get rid of "uei" column - need to ask for help with this.**
...
**MOVE THESE MAPS TO THE TOP**

**Need to fix the 2020 button on the 2024 map. when i select it, datawrapper renders with a login page and screws up the presentation**
